...
func decode(line string) [4]int {
	/*
		We know:
		- the 2-letter digit is 1
		- the 3-letter digit is 7
		- the 4-letter digit is 4
		- the 5-letter digits are 2, 3, 5
		- the 6-letter digits are 0, 6, 9
		- the 7-letter digit is 8

		Subtract bars 1 from bars 7 to get the top bar:
		...
		Subtract bars 7 from bars 4 to get the top-left and center bars:

		o . . o       ooooooo       o . . .
		o     o       .     o       o     .
		o     o       .     o  ___  o     .
		ooooooo  ___  . . . o  ___  ooooooo
		.     o       .     o       .     .
		.     o       .     o       .     .
		. . . o       . . . o       . . . .

		The 3 is the the 5-letter digit that contains 7 completely,
		2 and 5 are each missing one bar from 7. So we find 3.
		Subtract bars 7 from 3 to get the center and bottom bars:
		...
		We now have the top-left and center pair and the center and
		bottom pair. The one they have in common is the center bar.
		Knowing this we also know the top-left and bottom bars.

		Subtract from 8 all bars in 3 and the now known top-left bar:

		ooooooo       ooooooo       o . . .       . . . .
		o     o       .     o       o     .       .     .
		o     o       .     o       o     .  ___  .     .
		ooooooo  ___  ooooooo  ___  o . . .  ___  o . . .
		o     o       .     o       .     .       o     .
		o     o       .     o       .     .       o     .
		ooooooo       ooooooo       . . . .       o . . .

		This gives us the bottom-left bar.

		Find the 6 by looking at all 6-letter digits 0, 6, 9. Both 0
		and 0 contain all bars in 7, but 6 does not. That is how we
		find it. The top-right bar can be found by subtracting bars
		6 from bars 8:

		ooooooo       ooooooo       . . . o
		o     o       o     .       .     o
		o     o       o     .  ___  .     o
		ooooooo  ___  ooooooo  ___  . . . o
		o     o       o     o       .     .
		o     o       o     o       .     .
		ooooooo       ooooooo       . . . .

		The last missing bar is bottom-right. It can be found by
		subtracting the top-right bar from 1:
	...
	*/
	...
	// Sort digits by length, the first is now the 2-letter
	// digit 1, the second is the 3-letter digit 7, etc.
	...
	seven := digits[1]
	four := digits[2]
	two_three_five := []string{digits[3], digits[4], digits[5]}
	zero_six_nine := []string{digits[6], digits[7], digits[8]}
	eight := digits[9]

	var three string
	for _, candidate := range two_three_five {
		if containsAll(candidate, seven) {
			three = candidate
		}
	}

	var six string
	for _, candidate := range zero_six_nine {
		if !containsAll(candidate, seven) {
			six = candidate
		}
	}

	top := subtract(seven, one)
	topLeftAndCenter := subtract(four, seven)
	centerAndBottom := subtract(three, seven)
	center := common(topLeftAndCenter, centerAndBottom)
	bottom := subtract(centerAndBottom, center)
	topLeft := subtract(topLeftAndCenter, center)
	bottomLeft := subtract(subtract(eight, three), topLeft)
	topRight := subtract(eight, six)
	bottomRight := subtract(one, topRight)
	...
	/*
		...
		+--2--+
	*/
	bars := []string{top, center, bottom, topLeft, bottomLeft, topRight, bottomRight}
	const (
		o = false
		x = true
	)
	...
	match := func(num string) int {
		...
		panic("no pattern matches for " + num)
	}
...
var input = `aedcg db ecbdgf badfegc abfcde edb cbgfe bfdg bdgec agfbce | ecagd gcbde dbcefa bgfd
